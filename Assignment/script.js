...
function GenerateTable() {
    //Build an array containing the records.
    var records = [];
    ...
    table.id="myTable";
    table.classList="table table-inverse table-hover";
    table.border = "1";
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        headerCell.innerHTML = records[i];
    ...
    for (var i = 0; i < myRepo.length; i++) {
        ...
        for (var j = 0; j < records.length; j++) {
            ...
            cell.innerHTML = myRepo[i][records[j]];
        }
    }
...
//Filter table for searching and hiding elements not found
function myFunction() {
